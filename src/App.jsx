...
import newImage from "./images/kto.jpg";
...
function App() {
  return (
    <>
      ...
      <h1 className="text-2xl ml-8 my-3 font-bold">Trending Boys hostel...</h1>
      ...
      <h1 className="text-2xl ml-8 my-3 font-bold">Trending Girls hostel...</h1>
      <div className="flex fle-row justify-evenly">
        <Cards
          name="Neha"
          location="Kalopul"
