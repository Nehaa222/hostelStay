...
function HostelCard({ hostel, session }) {
  ...
  return (
    <div className="flex h-[250px] w-[750px] shadow-2xl rounded-2xl bg-slate-200">
      <img src={"https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG9zdGVsfGVufDB8fDB8fHww"} alt="" className="object-cover w-250px rounded-2xl" />
      <div className="flex flex-col justify-between w-full">
        ...
        <div className="flex justify-end w-full gap-4 px-3 mb-3">
          <Button color="success" className="text-lg text-seto" onClick={handleUpdate} disabled={loading}>
            {loading ? 'Updating...' : 'Update'}
          </Button>
          <Button color="danger" className="text-lg" onClick={handleDelete} disabled={loading}>
